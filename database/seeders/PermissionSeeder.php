...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'read-home', 'guard_name' => 'admin',]);
        Permission::create(['name' => 'read-contact', 'guard_name' => 'admin',]);
        Permission::create(['name' => 'read-activities', 'guard_name' => 'admin',]);
        ...
        Permission::create(['name' => 'show-messages', 'guard_name' => 'admin',]);
    }
}
