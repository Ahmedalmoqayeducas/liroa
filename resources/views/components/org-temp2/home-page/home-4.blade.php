            ...
            <div class="col-md-6 about-text">
                ...
                <div class="tabs-container">
                    ...
                    <div class="tab-content">
                        <div id="mission" class="tab-pane fade show active text-dark">
                            <p class="text-dark">We are committed to delivering innovative solutions and outstanding support to our
                                clients, ensuring long-term success and growth.</p>
                        </div>
                        <div id="vision" class="tab-pane fade text-dark">
                            <p class="text-dark">Our vision is to be a leader in our industry, providing top-notch services that empower
                                businesses and individuals to reach their full potential.</p>
                        </div>
                        <div id="strategy" class="tab-pane fade text-dark">
                            <p class="text-dark">We implement effective strategies that focus on innovation, collaboration, and efficiency
