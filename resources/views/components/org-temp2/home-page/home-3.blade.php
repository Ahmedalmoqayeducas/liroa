<div class="fusion-fullwidth fullwidth-box fusion-builder-row-4 fusion-flex-container has-pattern-background has-mask-background nonhundred-percent-fullwidth non-hundred-percent-height-scrolling"
    ...
    <div class="fusion-builder-row fusion-row fusion-flex-align-items-flex-start fusion-flex-content-wrap"
        ...
        <div class="container">
            <div class="grid-container" id="service-cards"></div>
        </div>
        ...
        {{-- <div
            ...
            <div class="fusion-builder-row fusion-row fusion-flex-align-items-flex-start fusion-flex-content-wrap">
                ...
                <div
                    ...
                    <div
                        class="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                        <i class="fa-solid fa-clipboard-list" style="font-size:56px; color:var(--awb-color6);"></i>
                        <div class="fusion-title title">
                            <h4 class="fusion-title-heading">Content Planning</h4>
                        </div>
                        <div class="fusion-text">
                            <p>Strategize your content for maximum engagement.</p>
                        </div>
                        <a class="fusion-button button-flat fusion-button-default-size"
                            href="expertise/content-planning/index.htm">
                            <span class="fusion-button-text">View Details</span>
                            <i class="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div
                    class="fusion-layout-column fusion_builder_column fusion-builder-column-12 fusion_builder_column_1_3 1_3 fusion-flex-column">
                    <div
                        class="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                        <i class="fa-solid fa-briefcase" style="font-size:56px; color:var(--awb-color6);"></i>
                        <div class="fusion-title title">
                            <h4 class="fusion-title-heading">Business Consulting</h4>
                        </div>
                        <div class="fusion-text">
                            <p>Optimize your business strategies for success.</p>
                        </div>
                        <a class="fusion-button button-flat fusion-button-default-size"
                ...
                <div
                    class="fusion-layout-column fusion_builder_column fusion-builder-column-13 fusion_builder_column_1_3 1_3 fusion-flex-column">
                    <div
                        class="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                        <i class="fa-solid fa-chart-line" style="font-size:56px; color:var(--awb-color6);"></i>
                        <div class="fusion-title title">
                            <h4 class="fusion-title-heading">Sales Management</h4>
                        </div>
                        <div class="fusion-text">
                ...
                <div
                    class="fusion-layout-column fusion_builder_column fusion-builder-column-14 fusion_builder_column_1_3 1_3 fusion-flex-column">
                    <div
                        class="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                        <i class="fa-solid fa-file-invoice-dollar" style="font-size:56px; color:var(--awb-color6);"></i>
                        <div class="fusion-title title">
                            <h4 class="fusion-title-heading">private taxation</h4>
                        </div>
                        <div class="fusion-text">
                            <p>Compellingly develop the cost effective infrastructures with intuitivism.</p>
                        </div>
