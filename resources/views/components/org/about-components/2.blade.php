                    ...
                    <div class="fusion-builder-row fusion-row fusion-flex-align-items-flex-start fusion-flex-content-wrap"
                        ...
                        <div class="fusion-layout-column fusion_builder_column fusion-builder-column-9 fusion_builder_column_1_2 1_2 fusion-flex-column"
                            ...
                            <div
                                ...
                                <div class="fusion-text fusion-text-11 sm-text-align-center fusion-text-no-margin"
                                ...
                                <div class="fusion-title title fusion-title-15 fusion-sep-none fusion-title-text fusion-title-size-two"
                                    ...
                                    <h2 class="fusion-title-heading title-heading-left sm-text-align-center"
                                        style="margin:0;">achieve your goals with purpose &amp; strategy
                                    </h2>
                                </div>
                                <div class="fusion-text fusion-text-12 sm-text-align-center"
                                    ...
                                    <p>Auisque cursus sed magnads vitae conubia pharetra auctor interdum
                                        dui metus augue.</p>
                                </div>
                                <div class="fusion-separator fusion-no-small-visibility"
                        ...
                        <div class="fusion-layout-column fusion_builder_column fusion-builder-column-10 fusion_builder_column_1_2 1_2 fusion-flex-column"
                            ...
                            <div
                                class="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                                <div class="fusion-progressbar fusion-progressbar-text-above-bar"
                                    ...
                                    <span class="progress-title"><span class="fusion-progressbar-text"
                                            id="awb-progressbar-label-1">Consulting</span> <span
                                            class="fusion-progressbar-value">85%</span></span>
                                    <div
                                        class="fusion-progressbar-bar progress-bar progress-striped active">
                                ...
                                <div class="fusion-progressbar fusion-progressbar-text-above-bar"
                                    style="--awb-margin-bottom:30px;--awb-textcolor:var(--awb-color8);--awb-height:15px;--awb-unfilledcolor:hsla(var(--awb-color4-h),var(--awb-color4-s),calc(var(--awb-color4-l) + 18%),var(--awb-color4-a));--awb-border-radius-top-left:50px;--awb-border-radius-top-right:50px;--awb-border-radius-bottom-left:50px;--awb-border-radius-bottom-right:50px;">
                                    <span class="progress-title"><span class="fusion-progressbar-text"
                                            id="awb-progressbar-label-2">Management</span> <span
                                            class="fusion-progressbar-value">76%</span></span>
                                    <div
                                        class="fusion-progressbar-bar progress-bar progress-striped active">
                                        <div class="progress progress-bar-content" style="width:0%;"
                                            role="progressbar" aria-labelledby="awb-progressbar-label-2"
                                            aria-valuemin="0" aria-valuemax="100" aria-valuenow="76">
                                        </div>
                                    </div>
                                </div>
                                <div class="fusion-progressbar fusion-progressbar-text-above-bar"
                                    style="--awb-margin-bottom:30px;--awb-textcolor:var(--awb-color8);--awb-height:15px;--awb-unfilledcolor:hsla(var(--awb-color4-h),var(--awb-color4-s),calc(var(--awb-color4-l) + 18%),var(--awb-color4-a));--awb-border-radius-top-left:50px;--awb-border-radius-top-right:50px;--awb-border-radius-bottom-left:50px;--awb-border-radius-bottom-right:50px;">
                                    <span class="progress-title"><span class="fusion-progressbar-text"
                                            id="awb-progressbar-label-3">Brainstorming</span> <span
                                            class="fusion-progressbar-value">92%</span></span>
                                    <div
                                        class="fusion-progressbar-bar progress-bar progress-striped active">
                                        <div class="progress progress-bar-content" style="width:0%;"
