...
<section class="features">
    <div class="container">
        ...
        <div class="row" data-aos="fade-up">
            <div class="col-md-5">
                <img src="{{ asset('org/img/features-1.svg') }}" class="img-fluid" alt="">
            </div>
        ...
        <div class="row" data-aos="fade-up">
            <div class="col-md-5 order-1 order-md-2">
                <img src="{{ asset('org/img/features-2.svg') }}" class="img-fluid" alt="">
            </div>
        ...
        <div class="row" data-aos="fade-up">
            <div class="col-md-5">
                <img src="{{ asset('org/img/features-3.svg') }}" class="img-fluid" alt="">
            </div>
        ...
        <div class="row" data-aos="fade-up">
            <div class="col-md-5 order-1 order-md-2">
                <img src="{{ asset('org/img/features-4.svg') }}" class="img-fluid" alt="">
            </div>
            <div class="col-md-7 pt-5 order-2 order-md-1">
