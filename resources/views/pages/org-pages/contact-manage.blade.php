...
@section('content')
            ...
            <div class="overflow-x-auto -mx-6">
                <div class="inline-block min-w-full align-middle">
                    <div class="overflow-hidden">
                        <table id="contactTable" class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                    ...
                                    <tr id="contact_{{ $contact->id }}">
                                        ...
                                        <td class="table-td ">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                <!-- Edit Button -->
                                                <button onclick="editContact({{ $contact->id }}, '{{ $contact->name }}', '{{ $contact->email }}', '{{ $contact->phone }}')"
    ...
    <script>
        ...
        document.getElementById('showCreatePopup').addEventListener('click', function() {
            Swal.fire({
                ...
                html: `
                    <input type="text" id="contactName" class="swal2-input" placeholder="Name">
                    <input type="email" id="contactEmail" class="swal2-input" placeholder="Email">
                    <input type="text" id="contactPhone" class="swal2-input" placeholder="Phone">
                `,
                focusConfirm: false,
                ...
                if (result.isConfirmed) {
                    ...
                    .catch(error => {
                        Swal.fire({
                            title: 'Error!',
                            text: error.response?.data?.message ?? 'An error occurred while connecting to the server.',
                            icon: 'error',
                            background: '#ffffff',
                            customClass: {
                                popup: 'custom-swal-popup',
        ...
        // 2) EDIT Contact
        function editContact(id, currentName, currentEmail, currentPhone) {
            Swal.fire({
                title: 'Edit Contact',
                html: `
                    <input type="text" id="contactName" class="swal2-input" placeholder="Name" value="${currentName}">
                    <input type="email" id="contactEmail" class="swal2-input" placeholder="Email" value="${currentEmail}">
                    <input type="text" id="contactPhone" class="swal2-input" placeholder="Phone" value="${currentPhone}">
                `,
                focusConfirm: false,
                showCancelButton: true,
    ...
    <style>
        ...
        /* Input field */
        .custom-swal-input {
            border: 1px solid #6c757d; /* gray border for input */
        }
        /* Confirm button */
        .custom-swal-confirm {
