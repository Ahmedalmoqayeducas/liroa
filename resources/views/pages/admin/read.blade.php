                                    ...
                                    <tr class="even" id="element_{{ $element->id }}">
                                        ...
                                        <td class="table-td">
                                            <span class="flex">
                                                <span class="w-7 h-7 rounded-full ltr:mr-3 rtl:ml-3 flex-none">
                                                    ...
                                                    <img src="{{asset( Storage::url("$element->image"))}}" alt="10"
                                        ...
                                        <td class="table-td ">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                ...
                                                <a class="action-btn edit" href="{{ route('admin.edit', $element->id) }}">
                                                    <iconify-icon icon="heroicons:pencil-square"></iconify-icon>
                                                </a>
                                                <button type="button" onclick="destroy({{ $element->id }})" class="action-btn delete">
