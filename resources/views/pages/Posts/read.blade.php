                                    ...
                                    <tbody
                                        ...
                                        @foreach ($data as $element)
                                            <tr class="even" id="element_{{ $element->id }}">
                                                ...
                                                <td class="table-td ">
                                                    <button class="action-btn btn-success" type="button"
                                                        {{-- href="{{ route('activities.update', $element->id) }}" --}} onclick="activitiesAdd({{ $element->id }})">
                                                        <iconify-icon
...
@section('scripts')
    <script>
        function destroy(id) {
            axios.delete(`/dash/posts/${id}`).then(function(response) {
    ...
    <script>
        function activitiesAdd(id) {
            axios.put(`/dash/actPostAdd/${id}`, {
                    activities: true
